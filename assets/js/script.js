...
const mailSendButton = document.getElementById("mailSendButton"); // Menambahkan variabel mailSendButton
...
const typed = new Typed(".multiple-text", {
   strings: ["Jr. Pentester", "Backend Dev"],
   typeSpeed: 80,
   backSpeed: 50,
   backDelay: 2000,
   loop: true,
...
function sendMail() {
   ...
   emailjs
      .send("service_l0cebzo", "template_b3t8o8m", params)
      .then(function (res) {
